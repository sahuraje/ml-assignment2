...
This project was trained and executed on the BITS Virtual Lab environment, and results reported above reflect that run. A screenshot of execution on BITS Virtual Lab is included in the final submitted PDF.